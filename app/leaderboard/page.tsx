...
export default function LeaderboardPage() {
    ...
    const renderRankingList = (
        ...
        showXP: "total" | "weekly" | "monthly" = "total"
    ) => {
        return (
                        ...
                        <CardContent>
                            <div className="grid gap-4 md:grid-cols-2">
                                {activeCompetitions.map((competition) => (
                                    <Card
                                        key={competition.id}
                                        className="border border-yellow-200 bg-gradient-to-r from-yellow-50 to-orange-50"
                                    >
                                        <CardContent className="p-4">
                        ...
                        >
                            ...
                            <TabsContent value="global" className="mt-6">
                                <div className="mb-4">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Top learners by total XP earned
                                    </p>
                                </div>
                ...
                <Card className="mt-8 border-0 shadow-lg">
                    ...
                    <CardContent>
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                            {Object.entries(leagueIcons).map(
                                ([league, Icon]) => {
                                    const isCurrentLeague =
                                        league === currentUser?.league;
                                    const leagueRankings =
                                        leaderboardStore.getLeagueRankings(
                                            league as keyof typeof leagueIcons
                                        );
                                            ...
                                            <CardContent className="p-4 text-center">
                                                <div
                                                    className={`w-12 h-12 rounded-full bg-gradient-to-r ${
                                                        leagueColors[
                                                            league as keyof typeof leagueColors
                                                        ]
                        ...
                        <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
                            ...
                            <div className="space-y-2 text-sm text-gray-600">
                                <div>
                                    🥉 <strong>Bronze:</strong> 0 - 1,999 XP
                                </div>
                                <div>
                                    🥈 <strong>Silver:</strong> 2,000 - 4,999 XP
                                </div>
                                <div>
                                    🥇 <strong>Gold:</strong> 5,000 - 9,999 XP
                                </div>
                                <div>
                                    💎 <strong>Platinum:</strong> 10,000 -
                                    14,999 XP
                                </div>
                                <div>
                                    💠 <strong>Diamond:</strong> 15,000+ XP
                                </div>
                            </div>
                        </div>
                    </CardContent>
