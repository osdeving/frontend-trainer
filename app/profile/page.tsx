...
export default function ProfilePage() {
    ...
    const getCategoryProgress = () => {
        ...
        return [
            {
                name: "Layout",
                progress: groupProgress.layout?.progress || 0,
                color: "bg-blue-500",
            },
            {
                name: "Typography",
                progress: groupProgress.typography?.progress || 0,
                color: "bg-green-500",
            },
            {
                name: "Colors",
                progress: groupProgress.colors?.progress || 0,
                color: "bg-purple-500",
            },
            {
                name: "Spacing",
                progress: groupProgress.spacing?.progress || 0,
                color: "bg-orange-500",
            },
            {
                name: "Effects",
                progress: groupProgress.effects?.progress || 0,
                color: "bg-pink-500",
            },
            {
                name: "Responsive",
                progress: groupProgress.responsive?.progress || 0,
                color: "bg-indigo-500",
            },
        ];
    };
    ...
    const LeagueIcon =
        leagueIcons[currentUser?.league as keyof typeof leagueIcons] || Shield;
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                <div className="text-center">
                                                    <div className="text-3xl font-bold text-blue-600 mb-2">
                                                        {progressStore.getTotalProgress()}
                                                        %
                                                    </div>
                                                    <div className="text-sm text-gray-600">
                                                        Course Completion
                                                    ...
                                                    <Progress
                                                        value={progressStore.getTotalProgress()}
                                                        className="mt-2"
                                                    />
                                                </div>
                                                <div className="text-center">
                                                    <div className="text-3xl font-bold text-green-600 mb-2">
                                                        {progressStore.getCompletedGroups()}
                                                        /6
                                                    </div>
                                                    <div className="text-sm text-gray-600">
                                                        Groups Completed
                                                ...
                                                <div className="text-center">
                                                    <div className="text-3xl font-bold text-purple-600 mb-2">
                                                        {progressStore.getTotalCompletedLessons()}
                                                    </div>
                                                    <div className="text-sm text-gray-600">
                                                        Lessons Completed
                                                    </div>
