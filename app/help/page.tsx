            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg border border-blue-200">
                <div className="flex items-center space-x-3 mb-4">
                    ...
                    <h3 className="text-xl font-bold text-gray-800">
                        Bem-vindo ao TailwindTrainer!
                    </h3>
                </div>
                <p className="text-gray-700 mb-4">
                    O TailwindTrainer é uma plataforma gamificada para aprender
                    TailwindCSS de forma interativa e divertida. Aqui você
                    encontrará tudo que precisa para dominar as classes
                        ...
                        <div className="flex items-start space-x-4 p-4 bg-green-50 rounded-lg border border-green-200">
                            ...
                            <div>
                                <h4 className="font-semibold text-green-800 mb-1">
                                    Escolha um Grupo de Aprendizado
                                </h4>
                                <p className="text-green-700 text-sm">
                                    Comece com &quot;Layout &amp;
                                    Positioning&quot; - é perfeito para
                                    iniciantes e ensina os fundamentos do
                                    Flexbox e Grid.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                            ...
                            <div>
                                ...
                                <p className="text-blue-700 text-sm">
                                    Leia o código CSS e digite a classe
                                    TailwindCSS equivalente. Use dicas se
                                    precisar!
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-4 p-4 bg-purple-50 rounded-lg border border-purple-200">
                            ...
                            <div>
                                <h4 className="font-semibold text-purple-800 mb-1">
                                    Ganhe sua Primeira Conquista
                                </h4>
                                <p className="text-purple-700 text-sm">
                                    Ao completar a primeira questão, você
                                    ganhará a conquista &quot;First Steps&quot;
                                    e 10 XP!
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-4 p-4 bg-orange-50 rounded-lg border border-orange-200">
                            ...
                            <div>
                                ...
                                <p className="text-orange-700 text-sm">
                                    Complete mais questões, mantenha streaks e
                                    desbloqueie novos grupos e desafios!
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <CardContent>
                    <div className="grid gap-4 md:grid-cols-2">
                        <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                            <div className="flex items-center space-x-2 mb-2">
                                ...
                                <span className="font-semibold text-yellow-800">
                                    Use o Preview Visual
                                </span>
                            </div>
                            <p className="text-yellow-700 text-sm">
                                Clique no ícone do olho para ver como o CSS se
                                aplica visualmente. Isso ajuda muito no
                                aprendizado!
                            </p>
                        </div>
                        ...
                        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                            <div className="flex items-center space-x-2 mb-2">
                                ...
                                <span className="font-semibold text-blue-800">
                                    Não Tenha Medo das Dicas
                                </span>
                            </div>
                            <p className="text-blue-700 text-sm">
                                As dicas são suas amigas! Use-as para aprender
                                os padrões do TailwindCSS.
                            </p>
                        </div>
                        ...
                        <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                            ...
                            <p className="text-green-700 text-sm">
                                Sequências de acertos desbloqueiam conquistas
                                especiais e multiplicam seu XP!
                            </p>
                        </div>
                        ...
                        <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                            ...
                            <p className="text-purple-700 text-sm">
                                Use o modo de revisão para praticar questões que
                                você errou. A repetição é chave!
                            </p>
                        </div>
                    </div>
                </CardContent>
                            ...
                            <div className="grid gap-4 md:grid-cols-3">
                                <div className="text-center p-4 bg-red-50 rounded-lg border border-red-200">
                                    ...
                                    <p className="text-sm text-red-700">
                                        Você tem 5 vidas. Perde 1 vida a cada
                                        erro. Sem vidas = fim do jogo!
                                    </p>
                                </div>
                                ...
                                <div className="text-center p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                                    ...
                                    <p className="text-sm text-yellow-700">
                                        Fácil: 10 XP, Médio: 15 XP, Difícil: 20
                                ...
                                <div className="text-center p-4 bg-orange-50 rounded-lg border border-orange-200">
                                    ...
                                    <p className="text-sm text-orange-700">
                                        Acertos consecutivos. Streaks longos =
                                ...
                                <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-blue-700">
                                            Dicas contextuais baseadas na
                                            categoria da questão. Use sem medo!
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-green-700">
                                            Veja como o CSS se aplica
                                            visualmente em um elemento de
                                            exemplo.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-3 p-3 bg-purple-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-purple-700">
                                            Pratique apenas as questões que você
                                            errou para reforçar o aprendizado.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <CardContent>
                    <div className="space-y-6">
                        <div className="grid gap-4 md:grid-cols-2">
                            <div className="p-4 border border-green-200 rounded-lg bg-green-50">
                                ...
                                <ul className="space-y-2 text-sm text-green-700">
                                    <li>
                                        • <strong>Free Practice:</strong> Sem
                                        limites, com dicas e preview
                                    </li>
                                    <li>
                                        • <strong>Quick Practice:</strong> 10
                                        questões aleatórias
                                    </li>
                            ...
                            <div className="p-4 border border-blue-200 rounded-lg bg-blue-50">
                                ...
                                <ul className="space-y-2 text-sm text-blue-700">
                                    <li>
                                        • <strong>Speed Round:</strong> 15
                                        questões em 5 minutos
                                    </li>
                                    <li>
                                        • <strong>Lightning Round:</strong> 20
                                        questões em 3 minutos
                                    </li>
                            ...
                            <div className="p-4 border border-red-200 rounded-lg bg-red-50">
                                ...
                                <ul className="space-y-2 text-sm text-red-700">
                                    <li>
                                        • <strong>Survival Mode:</strong> 3
                                        vidas, com dicas
                                    </li>
                                    <li>
                                        • <strong>Hardcore Survival:</strong> 3
                                        vidas, sem ajudas
                                    </li>
                            ...
                            <div className="p-4 border border-purple-200 rounded-lg bg-purple-50">
                                ...
                                <ul className="space-y-2 text-sm text-purple-700">
                                    ...
                                    <li>
                                        • Requer grupos específicos completos
                                    </li>
                                    <li>
                                        • 100-250 XP + badges especializados
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                            ...
                            <p className="text-yellow-700 text-sm">
                                Comece com modos de prática para se
                                familiarizar, depois parta para cronometrados e
                                sobrevivência. Desafios temáticos são ótimos
                                para focar em áreas específicas!
                            </p>
                        </div>
                    </div>
                </CardContent>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="p-3 bg-orange-50 rounded-lg border border-orange-200">
                                        ...
                                        <ul className="text-sm text-orange-700 space-y-1">
                                            <li>
                                                • On Fire! (5 acertos seguidos)
                                            </li>
                                            <li>
                                                • Unstoppable (10 acertos
                                                seguidos)
                                            </li>
                                            <li>
                                                • Legendary Streak (25 acertos
                                                seguidos)
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div className="space-y-3">
                                    <div className="p-3 bg-purple-50 rounded-lg border border-purple-200">
                                        ...
                                        <ul className="text-sm text-purple-700 space-y-1">
                                            <li>
                                                • Layout Master (grupo completo)
                                            </li>
                                            <li>
                                                • Typography Expert (grupo
                                                completo)
                                            </li>
                                            <li>
                                                • Color Wizard (grupo completo)
                                            </li>
                                            <li>
                                                • Tailwind Grandmaster (todos os
                                                grupos)
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                                        ...
                                        <ul className="text-sm text-green-700 space-y-1">
                                            <li>
                                                • Speed Demon (resposta em
                                                &lt;5s)
                                            </li>
                                            <li>
                                                • No Hints Needed (20 sem dicas)
                                            </li>
                                            <li>
                                                • Review Champion (5 revisões)
                                            </li>
                                            <li>
                                                • Consistent Learner (7 dias
                                                seguidos)
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div>
                            ...
                            <div className="grid gap-4 md:grid-cols-3">
                                <div className="text-center p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                                    ...
                                    <p className="text-sm text-yellow-700">
                                        Pontos de experiência para subir de
                                        nível e liga
                                    </p>
                                </div>
                                ...
                                <div className="text-center p-4 bg-blue-50 rounded-lg border border-blue-200">
                                    ...
                                    <p className="text-sm text-blue-700">
                                        Distintivos especiais para mostrar suas
                                        conquistas
                                    </p>
                                </div>
                                ...
                                <div className="text-center p-4 bg-purple-50 rounded-lg border border-purple-200">
                                    ...
                                    <p className="text-sm text-purple-700">
                                        Títulos exclusivos para exibir no seu
                                        perfil
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="p-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg border border-yellow-200">
                            <div className="flex items-center space-x-2 mb-2">
                                ...
                                <span className="font-semibold text-orange-800">
                                    Dica de Maximização de XP
                                </span>
                            </div>
                            <p className="text-orange-700 text-sm">
                                Para ganhar XP rapidamente: complete grupos
                                inteiros (conquistas de maestria), mantenha
                                streaks longos, participe de desafios
                                cronometrados e competições semanais!
                            </p>
                        </div>
                    </div>
                </CardContent>
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="p-4 border border-blue-200 rounded-lg">
                                    ...
                                    <ul className="space-y-1 text-sm text-blue-700">
                                        <li>
                                            • <strong>Global:</strong> Ranking
                                            por XP total de todos os tempos
                                        </li>
                                        <li>
                                            • <strong>Semanal:</strong>{" "}
                                            Competição semanal por XP ganho
                                        </li>
                                        <li>
                                            • <strong>Mensal:</strong>{" "}
                                            Competição mensal por XP ganho
                                        </li>
                                        <li>
                                            • <strong>Amigos:</strong>{" "}
                                            Compare-se apenas com seus amigos
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="p-4 border border-purple-200 rounded-lg">
                                    ...
                                    <ul className="space-y-1 text-sm text-purple-700">
                                        <li>
                                            • 🥉 <strong>Bronze:</strong> 0 -
                                            1,999 XP
                                        </li>
                                        <li>
                                            • 🥈 <strong>Silver:</strong> 2,000
                                            - 4,999 XP
                                        </li>
                                        <li>
                                            • 🥇 <strong>Gold:</strong> 5,000 -
                                            9,999 XP
                                        </li>
                                        <li>
                            ...
                            <div className="space-y-4">
                                <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                                    ...
                                    <p className="text-sm text-yellow-700 mb-2">
                                        Competição semanal pelo maior XP ganho
                                    </p>
                                    <div className="text-xs text-yellow-600">
                                        <strong>Recompensas:</strong> 1º lugar:
                                        500 XP + Badge &quot;Weekly
                                        Champion&quot; + Título &quot;Sprint
                                        Master&quot;
                                    </div>
                                </div>
                                ...
                                <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                                    ...
                                    <p className="text-sm text-purple-700 mb-2">
                                        Torneio temático focado em questões de
                                        Flexbox
                                    </p>
                                    <div className="text-xs text-purple-600">
                                        <strong>Recompensas:</strong> 1º lugar:
                                        1000 XP + Badge &quot;Flexbox
                                        Champion&quot; + Título &quot;Flexbox
                                        Grandmaster&quot;
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                                    ...
                                    <ul className="text-sm text-green-700 space-y-1">
                                        <li>
                                            • Foque em desafios de alto valor
                                            (200+ XP)
                                        </li>
                                        <li>
                                            • Complete grupos para conquistas de
                                            maestria
                                        </li>
                                        <li>• Mantenha streaks longos</li>
                                        <li>
                                            • Participe de competições ativas
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                                    ...
                                    <ul className="text-sm text-blue-700 space-y-1">
                                        ...
                                        <li>
                                            • Aproveite multiplicadores de XP
                                        </li>
                                        <li>
                                            • Estude padrões dos concorrentes
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <CardContent>
                    <div className="space-y-6">
                        <div>
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="p-4 border border-blue-200 rounded-lg">
                                    ...
                                    <ul className="space-y-1 text-sm text-blue-700">
                                        <li>
                                            • Atividade semanal com gráficos
                                        </li>
                                        <li>• Progresso por categoria</li>
                                        <li>
                                            • Ações rápidas para continuar
                                            aprendendo
                                        </li>
                                        <li>
                                ...
                                <div className="p-4 border border-purple-200 rounded-lg">
                                    ...
                                    <ul className="space-y-1 text-sm text-purple-700">
                                        ...
                                        <li>
                                            • Raridade e recompensas de cada
                                            conquista
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="p-4 border border-orange-200 rounded-lg">
                                    ...
                                    <ul className="space-y-1 text-sm text-orange-700">
                                        <li>
                                            • Performance detalhada (precisão,
                                            tempo)
                                        </li>
                        ...
                        <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-200">
                            ...
                            <p className="text-blue-700 text-sm">
                                Use as estatísticas do perfil para identificar
                                pontos fracos e focar seus estudos. Se sua
                                precisão em &quot;Effects&quot; está baixa,
                                dedique mais tempo a esse grupo!
                            </p>
                        </div>
                    </div>
                </CardContent>
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    Aprenda como usar todas as funcionalidades
                                    do TailwindTrainer
                                </p>
                            </div>
                        </div>
            ...
            <main className="max-w-6xl mx-auto px-4 py-8">
                    ...
                    <CardContent className="pt-8 pb-6">
                        <div className="text-center mb-6">
                            ...
                            <p className="text-blue-100">
                                Escolha um tópico abaixo para aprender mais
                                sobre o TailwindTrainer
                            </p>
                        </div>
                ...
                <div className="grid gap-8 lg:grid-cols-4">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        {selectedSection === "learning-system" &&
                        ...
                        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow cursor-pointer bg-gradient-to-r from-blue-500 to-blue-600 text-white">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-sm text-blue-100">
                                    Inicie sua jornada com o primeiro grupo
                                </p>
                            </CardContent>
                        </Card>
                    </Link>
                        ...
                        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow cursor-pointer bg-gradient-to-r from-purple-500 to-purple-600 text-white">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-sm text-purple-100">
                                    Teste suas habilidades em modos especiais
                                </p>
                            </CardContent>
                        </Card>
                    </Link>
