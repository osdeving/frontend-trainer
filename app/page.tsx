                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">
                                    {activeTitle
                                        ? `${activeTitle} • Master CSS utilities`
                                        : "Master CSS utilities"}
                                </p>
                            </div>
                        </div>
                    ...
                    <Card className="border-0 shadow-lg">
                        <CardContent className="p-4 text-center">
                            ...
                            <div className="text-2xl font-bold text-green-600">
                                {achievementProgress.stats.correctAnswers}
                            </div>
                    ...
                    <Card className="border-0 shadow-lg">
                        <CardContent className="p-4 text-center">
                            ...
                            <div className="text-2xl font-bold text-orange-600">
                                {achievementProgress.stats.maxStreak}
                            </div>
                            <div className="text-sm text-gray-600">
                                Best Streak
                            </div>
                    ...
                    <Card className="border-0 shadow-lg">
                        <CardContent className="p-4 text-center">
                            ...
                            <div className="text-2xl font-bold text-purple-600">
                                {achievementProgress.stats.perfectQuizzes}
                            </div>
                            <div className="text-sm text-gray-600">
                                Perfect Quizzes
                            </div>
                            ...
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    ...
                                    <p className="text-red-100 text-sm">
                                        Test your skills with timed and survival
                                        modes
                                    </p>
                                </div>
                            ...
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    ...
                                    <p className="text-yellow-100 text-sm">
                                        Unlock badges and earn exclusive titles
                                    </p>
                                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {classGroups.map((group, index) => {
                            ...
                            const groupProgress =
                                progressStore.getGroupProgress(group.id);
                            const isCompleted = groupProgress.progress === 100;
                            const isInProgress =
                                groupProgress.progress > 0 &&
                                groupProgress.progress < 100;
                            const isUnlocked = progressStore.isGroupUnlocked(
                                group.id
                            );
                                    ...
                                    {isUnlocked ? (
                                        <Link href={`/learn/${group.id}`}>
                                            <CardHeader className="pb-3">
                                                <div className="flex items-center justify-between">
                                                    <div
                                                        className={`w-12 h-12 rounded-xl bg-gradient-to-r ${group.color} flex items-center justify-center`}
                                                    >
                                            ...
                                            <CardContent>
                                                <div className="space-y-3">
                                                    <div className="flex justify-between text-sm">
                                                        <span>
                                                            {
                                                                groupProgress.completedLessons
                                                            }
                                                            /
                                                            {
                                                                groupProgress.totalLessons
                                                            }{" "}
                                                            lessons
                                                        </span>
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg">
                                <div className="text-2xl font-bold text-green-600">
                                    {progress.dailyGoals.lessonsToday}/
                                    {progress.dailyGoals.targetLessons}
                                </div>
                            ...
                            <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg">
                                <div className="text-2xl font-bold text-blue-600">
                                    {progress.dailyGoals.xpToday}/
                                    {progress.dailyGoals.targetXP}
                                </div>
