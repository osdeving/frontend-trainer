...
const spaceMissions: MissionLevel[] = [
    {
        ...
        description:
            "Lance a nave espacial para o centro da galáxia. Use Grid para posicioná-la.",
        missionType: "grid",
    ...
    },
    {
        ...
        description:
            "Guide a nave para o canto superior direito da estação espacial.",
        missionType: "grid",
    ...
    },
    {
        ...
        description:
            "Organize 3 naves em uma linha horizontal no centro do espaço.",
        missionType: "grid",
    ...
    },
    {
        ...
        title: "Sistema Solar",
        description:
            "Crie um sistema com planeta central e satélites ao redor.",
    ...
    },
    {
        ...
        description:
            "Posicione a estação no canto superior direito, flutuando sobre tudo.",
        missionType: "position",
    ...
    },
    {
        ...
        title: "Nave Ampliada",
        description:
            "Aumente a nave para 150% do tamanho original para melhor visibilidade.",
        missionType: "transform",
    ...
    },
    {
        ...
        description:
            "Organize uma frota: naves em linha, planeta central e satélites nos cantos.",
...
export default function SpaceMissionGame() {
    ...
    const renderSpaceField = () => {
        ...
        const baseClasses =
            "w-full h-64 bg-gradient-to-b from-indigo-900 via-purple-900 to-black rounded-lg border-4 border-indigo-500 relative overflow-hidden";

        // Classes aplicadas pelo usuário
        const containerClasses = `${baseClasses} ${
            userInput || "grid place-items-start"
        }`;
        ...
        return (
            <div className="relative">
                ...
                <div className="absolute inset-0 rounded-lg pointer-events-none z-0">
                    <div className={targetClasses}>{renderElements(true)}</div>
                </div>

                {/* Container atual (posições dos elementos baseado no input) */}
                <div className={containerClasses}>{renderElements(false)}</div>
            ...
            <Card className="w-full max-w-4xl mx-auto">
                <CardContent className="text-center py-12">
                    ...
                    <p className="text-lg text-gray-600 mb-6">
                        Parabéns, Comandante! Você completou todas as{" "}
                        {spaceMissions.length} missões espaciais!
                    </p>
            ...
            <CardHeader>
                <div className="flex justify-between items-center">
                    ...
                    <div className="text-sm text-gray-500">
                        {completedMissions.length}/{spaceMissions.length}{" "}
                        completas
                    </div>
                </div>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                        ...
                        style={{
                            width: `${
                                ((currentMission + 1) / spaceMissions.length) *
                                100
                            }%`,
                        }}
                    />
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        {isCorrect && (
                            <Button
                                onClick={nextMission}
                                disabled={
                                    currentMission >= spaceMissions.length - 1
                                }
                ...
                <div className="flex gap-1 flex-wrap">
                    {spaceMissions.map((_, index) => (
                        <Button
                            key={index}
                            variant={
                                index === currentMission ? "default" : "outline"
                            }
                            size="sm"
